...
研究上は、少なくとも次の領域を区別できるようにしておくと整理しやすいです。
...
研究のため、まず古い `mallinfo()` の考え方を簡単に押さえると、割り当て器が次のような情報を持っていることが見えてきます。
...
ただし、これも実運用の性能分析ツールというよりは、観察や研究向けの道具と考える方が適切です。
...
また、C 言語の研究という観点では、ヒープ管理そのものよりも「寿命の異なる領域をどう使い分けるか」が重要です。
